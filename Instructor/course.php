...
<div class="dashboard-container">
    <nav class="sidebar">
        ...
        <ul class="nav-menu">
            <li class="nav-item"><a href="../InstructorHtml/InstructorDash.html" class="nav-link"><i class="fas fa-home"></i> Dashboard</a></li>
            <li class="nav-item"><a href="../InstructorHtml/InstructCourses.html" class="nav-link active"><i class="fas fa-book-open"></i> Courses</a></li>
            <li class="nav-item"><a href="../InstructorHtml/InstructorStudent.html" class="nav-link"><i class="fas fa-users"></i> Students</a></li>
            <li class="nav-item"><a href="../InstructorHtml/InstructorCourse.html" class="nav-link"><i class="fas fa-chalkboard-teacher"></i> Add Course</a></li>
            <li class="nav-item"><a href="../InstructorHtml/InstructorSettings.html" class="nav-link"><i class="fas fa-cog"></i> Settings</a></li>
        </ul>
    </nav>
